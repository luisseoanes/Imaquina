...
const base =
  ...
  "transition active:scale-[0.98] disabled:bg-surface-muted disabled:text-content-muted " +
  "disabled:border-line disabled:shadow-none disabled:pointer-events-none " +
