/** Armazón del panel de administración. Mismo lenguaje visual que el Studio y
 *  el panel docente: barra lateral clara con grupos, cabecera lineal con
 *  saludo + buscador, acento ámbar en el activo, tarjeta de ayuda abajo.
 */
...
import robotHelp from "@/assets/illustrations/robot-4.svg";
...
function LangToggle() {
  ...
  return (
    <div
      role="group"
      aria-label={t("admin.header.lang")}
  ...
  return (
    <div className="relative mt-4">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-surface-inverse px-4 pb-4 pt-8 text-content-inverse">
        ...
        />
        <p className="relative text-sm font-bold">{t("admin.help.title")}</p>
...
function Topbar({ onMenu }: { onMenu: () => void }) {
  ...
  const nombre =
    me?.full_name?.trim().split(/\s+/)[0] || t("admin.header.defaultName");
